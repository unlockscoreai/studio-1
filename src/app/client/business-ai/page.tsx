  ...
  return (
    <Card className="text-center p-10 flex flex-col items-center">
        ...
        <CardDescription className="mt-2 mb-6 max-w-xl mx-auto">
            Transition from personal credit repair to building a fundable business. Our Business AI plan gives you the tools and insights to secure funding.
        </CardDescription>
        <div className="p-6 border rounded-lg bg-background w-full max-w-md text-left">
            ...
            <ul className="space-y-3">
                <li className="flex items-start gap-3">
                    ...
                    <span><strong>Free Business Fundability Scan:</strong> Instantly see how lenders view your business with our AI-powered audit.</span>
                </li>
                <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-1 shrink-0" />
                    <span><strong>Interactive Business Checklist:</strong> Follow a step-by-step guide to build a rock-solid, fundable business foundation.</span>
                </li>
                <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-1 shrink-0" />
