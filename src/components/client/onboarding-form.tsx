...
import { notifyAffiliate } from '@/app/client/onboarding/actions';
...
export function OnboardingForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    // Simulate API call to save data and upload files
    ...
    // In a real app, you would get these values from the authenticated user's data.
    const affiliateId = "creditup-solutions";
    const clientName = "Sarah Lee";
    await notifyAffiliate(affiliateId, clientName);
    ...
    // form.reset(); // Commenting out reset to keep the success message visible
  }
  ...
  if (isSuccess) {
    return (
        <Alert variant="default" className="border-green-500 text-green-700">
            ...
            <AlertDescription>
                Your onboarding information has been received. Your referring affiliate has been notified and your first dispute letter is ready for delivery.
            </AlertDescription>
        </Alert>
    )
  }
